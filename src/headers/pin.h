...
// Pico.
    ...
    #define PIN_FUNC 0
    #define PIN_LED_UP 0
    #define PIN_LED_LEFT 0
    #define PIN_LED_DOWN 0
    #define PIN_LED_RIGHT 0
    #define PIN_TOUCH_OUT 0
    #define PIN_TOUCH_IN 0
    #define PIN_ROTARY_B 0
    ...
    // Expanders.
    #define PIN_SELECT_1 0
    #define PIN_SELECT_2 0
    #define PIN_DPAD_LEFT 9
    #define PIN_DPAD_RIGHT 10
    ...
    #define PIN_START_1 17
    #define PIN_START_2 18
    #define PIN_A 13
    #define PIN_B 14
    #define PIN_X 15
    #define PIN_Y 16
    ...
    #define PIN_DHAT_UP 23
    #define PIN_DHAT_DOWN 24
    #define PIN_R1 5
    #define PIN_R2 6
    #define PIN_R3 7
    #define PIN_R4 8
